...
def rcrack(uid,pwx,tl):
    ...
    'accept-language': 'en-MM,en;q=0.9,bn-MM;q=0.8,bn;q=0.7,en-GB;q=0.6,en-US;q=0.5',
    'cache-control': 'max-age=0',
    # Requests sorts cookies= alphabetically
    # 'cookie': 'datr=3clQZPB3lCvSrqUTAhjsioUs; sb=3clQZKYVRJCHu5gzgK0EBAzX; m_pixel_ratio=2; wd=360x712; fr=0hXruStvRqtbzFOEK..BkUdR7.O8.AAA.0.0.BkUzHo.AWXtcDjO6ME',
